...
tkinter.Label(window,text="USER LOGIN",font=("Times New Roman",20,"bold"),bg="Light Green",padx=50).place(x=110,y=20)
...
label1 = tkinter.Label(window,text="Student List:",font=("Times New Roman",20,"bold"))
...
def selection():
    selection="Radio Button Selected.."+str(radio.get())
    label.configure(text=selection)    

b1 = tkinter.Button(window,text = "Login",font=("Times New Roman",20,"bold"),command=getUserPswd,fg="White",bg="Blue",padx=80).place(x=110,y=200)
...
r1 = tkinter.Radiobutton(window,text = "Java",font=("Times New Roman",10,"bold"),command=selection,variable=radio,value=1)
r1.place(x=450,y=360)
r2 = tkinter.Radiobutton(window,text = "C++",font=("Times New Roman",10,"bold"),command=selection,variable=radio,value=2)
r2.place(x=450,y=390)
r3 = tkinter.Radiobutton(window,text = "Python",font=("Times New Romn",10,"bold"),command=selection,variable=radio,value=3)
r3.place(x=450,y=420)
